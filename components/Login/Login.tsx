...
const Login = (props: LoginProps) => {
  const { onSignIn, loginHeader, loginLogoAltText, loginSlogan, loginButtonText, 
          loginPasswordPlaceholder, loginUsernamePlaceholder } = props
  ...
  return (
    <Layout style={styles.container}>
        ...
        <FadeInView style={{width: '100%'}} duration={1700}>
            <Text category='h1' style={styles.header}>{loginHeader}</Text>
            <Text category='p1' style={styles.slogan}>{loginSlogan}</Text>
            <Input
                value={username}
